...
<span data-ttu-id="11c5a-104">[上一篇 - 添加模型](adding-model.md)
[下一篇 - 控制器方法和视图](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="11c5a-104">[Previous - Add a model](adding-model.md)
