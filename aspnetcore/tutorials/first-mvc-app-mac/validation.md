...
keywords: "ASP.NET Core, 验证, DataAnnotations"
ms.author: riande
manager: wpickett
ms.date: 06/13/2017
...
<span data-ttu-id="66605-104">[上一篇 - 添加字段](new-field.md)
[下一篇 - 检查详细信息和删除方法](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="66605-104">[Previous - Add a field](new-field.md)
