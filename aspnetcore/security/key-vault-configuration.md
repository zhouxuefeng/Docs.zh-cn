...
* [基本示例](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/key-vault-configuration/samples/basic-sample/1.x)-读取到应用的密钥值。
* [密钥名称前缀示例](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/key-vault-configuration/samples/key-name-prefix-sample/1.x)-读取机密值使用密钥名称作为前缀表示版本的应用，这允许你加载一组不同的每个应用程序版本的机密值。 
...
[!code-csharp[程序](key-vault-configuration/samples/basic-sample/2.x/Program.cs?name=snippet1&highlight=2,7-10)]
...
[!code-csharp[配置生成器](key-vault-configuration/samples/key-name-prefix-sample/2.x/Program.cs?name=snippet1&highlight=12)]
