...
**图 1**： 异常详细信息 YSOD 包括有关异常的信息  
 ([单击以查看实际尺寸的图像](displaying-a-custom-error-page-cs/_static/image3.png))
...
**图 2**： 运行时错误 YSOD 不包含任何错误详细信息  
 ([单击以查看实际尺寸的图像](displaying-a-custom-error-page-cs/_static/image6.png))
...
**图 3**： 自定义错误页提供了更定制的外观和感觉  
 ([单击以查看实际尺寸的图像](displaying-a-custom-error-page-cs/_static/image9.png))
...
**图 5**： 设计你的自定义错误页  
 ([单击以查看实际尺寸的图像](displaying-a-custom-error-page-cs/_static/image14.png))
...
**图 6**: ASP.NET 运行时显示配置错误页在响应向无效请求 ([单击以查看实际尺寸的图像](displaying-a-custom-error-page-cs/_static/image17.png))
