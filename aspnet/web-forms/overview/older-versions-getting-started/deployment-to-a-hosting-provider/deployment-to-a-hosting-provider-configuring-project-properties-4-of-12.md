...
- **预编译此应用程序，然后发布**未选中。 在大多数情况下，没有必要预编译 web 应用程序项目。 有关此选项的详细信息，请参阅[打包/发布 Web 选项卡上，项目属性](https://msdn.microsoft.com/en-us/library/dd410108(v=vs.110).aspx)和[高级预编译设置对话框](https://msdn.microsoft.com/en-us/library/hh475319(v=vs.110).aspx)。
