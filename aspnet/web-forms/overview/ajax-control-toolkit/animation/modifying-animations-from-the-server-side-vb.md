...
---
<a name="modifying-animations-from-the-server-side-vb"></a>修改动画从服务器端 (VB)
====================
...
使用服务器端 C# /VB 代码创建动画 ([单击以查看实际尺寸的图像](modifying-animations-from-the-server-side-vb/_static/image3.png))
