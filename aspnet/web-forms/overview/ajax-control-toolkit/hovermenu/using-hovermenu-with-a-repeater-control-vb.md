...
---
<a name="using-hovermenu-with-a-repeater-control-vb"></a>转发器控件 (VB) 中使用 HoverMenu
====================
...
[![转发器在每个项旁边会出现的悬停菜单](using-hovermenu-with-a-repeater-control-vb/_static/image2.png)](using-hovermenu-with-a-repeater-control-vb/_static/image1.png)

转发器在每个项旁边会出现的悬停菜单 ([单击以查看实际尺寸的图像](using-hovermenu-with-a-repeater-control-vb/_static/image3.png))
