...
---
<a name="jqueryvalidate-version-18"></a>jquery.validate 版本 1.8
====================
在 CDN 上托管以下文件：
...
- 在 http://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages 本地化文件\_# #.js 其中 # # 是 loc 代码。
