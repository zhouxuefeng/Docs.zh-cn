...
**图 01**： 创建 LINQ to SQL 类 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image2.png))
...
**图 02**: 实体数据模型设计器 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image4.png))
...
**图 03**: 添加控制器菜单 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image6.png))
...
**图 04**: 添加控制器对话框 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image8.png))
...
**图 05**： 添加视图 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image10.png))
...
**图 06**: 添加视图对话框 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image12.png))
...
[![表的电影](displaying-a-table-of-database-data-vb/_static/image7.jpg)](displaying-a-table-of-database-data-vb/_static/image13.png)

**图 07**： 电影的表 ([单击以查看实际尺寸的图像](displaying-a-table-of-database-data-vb/_static/image14.png))
...
列出 4 中的视图包含一个 For 循环访问所有电影每个循环。 为每个的电影，部分 MovieTemplate 用于格式化影片。 MovieTemplate 呈现通过调用 RenderPartial() 帮助器方法。
